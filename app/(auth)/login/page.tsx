...
const Login = () => {
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (data) => {
        ...
        try {
            ...
            reset()
            const { token, user: { id: userId } } = response.data;
                        ...
                        <div className="input w-full">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="mail space-y-2 my-3">
                                    ...
                                    <input className="w-full h-10 rounded-sm bg-[#1e1f22] pl-2" type="text"
                                        {...register("email")}
                                    />
                                    {errors.email && (
                                ...
                                <button className="h-11 w-full rounded-sm bg-[#5865f2] my-2 hover:bg-[#434ece] text-white font-semibold" type="submit">Log in</button>
                            </form>
